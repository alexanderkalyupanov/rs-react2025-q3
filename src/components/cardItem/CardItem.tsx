      ...
      >
        ...
        <div className="pl-3 pt-2">
          ...
          <p className="text-rose-100 ">
            <span className="text-pink-200 dark:text-zinc-50">Species: </span>
            {character.species}
          </p>
          <p className="text-rose-100">
            <span className="text-pink-200 dark:text-zinc-50 ">Gender:</span>{' '}
            {character.gender}
          </p>
          <p className="text-rose-100">
            <span className="text-pink-200 dark:text-zinc-50">Status:</span>{' '}
            {character.status}
          </p>
          <div className="flex">
            <input
